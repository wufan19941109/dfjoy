    ...
    <div class="col-sm-8">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form class="form-horizontal m-t" id="signupForm" method="post" action="{{route('admin.userAddDo')}}">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="form-group">
                        <label class="col-sm-1 control-label">用户名：</label>
                        <div class="col-sm-8">
                            <input type="text" id="username"  name="emplName" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input id="nickname" name="nickname" class="form-control" type="text" aria-required="true" aria-invalid="false">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <span id="checkPassword" style="color: red; display: none" class="help-block m-b-none"><i class="fa fa-info-circle"></i>密码不一致</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label   class="col-sm-1 control-label">手机号：</label>
                        <div class="col-sm-8">
                            <input id="mobile" name="phoneNum" class="form-control" type="text">
