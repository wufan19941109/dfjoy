...
<div id="login-page">
    <div class="container">
        ...
        <form class="form-login" method="post" action="{{route('admin.loginDo')}}">

            <h2 class="form-login-heading">登录后台</h2>
            <div class="login-wrap">

                <input type="hidden" name="_token" id="" value="{{csrf_token()}}">
                <input type="text" class="form-control" name="emplName" placeholder="用户名" autofocus value="{{old('emplName')}}">
                <br>
                <input type="password" class="form-control" name="password" placeholder="密码">
                <br/>
                <input type="text" class="form-control" name="cap" placeholder="验证码">
                <br/>
                <div style="width: 100%;height: 30px">
                    <img src="{!! captcha_src() !!}" alt="" id="cap"/>
                </div>
...
<script>
    $.backstretch("{{asset('admin/assets')}}//img/login-bg.jpg", {speed: 500});
</script>
