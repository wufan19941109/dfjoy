...
@section('content')
    <div class="row">
        <div class="col-lg-12 main-chart">
            <a href="{{route('admin.FAQCateAdd')}}"><button type="button" class="btn btn-primary"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">添加FAQ分类</font></font></button></a>
                ...
                createdRow:function(row,data){
                    ...
                    var htmlDo =`<div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="{{url('admin/FAQCateUpdate/')}}/${data.id}" class="font-bold">修改</a>
                                    </li>
                                    <li class="divider"></li>

                                    <li><a href="javascript:if(confirm('确实要删除吗?'))location='{{url('admin/FAQCateDel/')}}/${data.id}'">删除</a>

                                    </li>
                                </ul>
                            </div>`;

                    $(row).find('td:eq(2)').html(htmlDo);
                }
