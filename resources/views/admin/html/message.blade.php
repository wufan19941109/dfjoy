        ...
        <div class="col-lg-12 main-chart">
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example">
                ...
                <div class="input-group">
                    <input type="text" id="kw" style="width: 20%;float: right" placeholder="按信息查找" class="input-sm form-control"> <span class="input-group-btn">
                ...
                createdRow:function(row,data){
                    ...
                    var htmlDo =`<div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="javascript:if(confirm('确实要删除吗?'))location='{{url('admin/messageDel/')}}/${data.id}'">删除</a>
