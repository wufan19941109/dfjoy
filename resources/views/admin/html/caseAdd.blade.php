    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form class="form-horizontal m-t" id="signupForm" method="post" action="{{route('admin.caseAddDo')}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" id="caseContent"  name="caseContent" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="date" id="caseDate"  name="caseDate" class="form-control">
                    ...
                    <input type="hidden" name="caseImgs" id="indexImgUrl">
